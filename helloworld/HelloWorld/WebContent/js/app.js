	...
	$.extend(Plugin.prototype, {
		...
		_render: function(obj) {
			...
			if (obj) {
				...
				<span class="weather__main-temp">${Math.round(obj.tempCur-273)}&deg;${this.settings.tempUnit}</span><br>
				...
				${this.settings.displayHumidity ? `<span class="weather__info">습 도: ${obj.humidity}%</span><br>` : ''}
				</div></div>
				</div>`;
