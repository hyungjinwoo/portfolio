...
<div id="myReviewPlan-div">
	...
	<section class="List-container">
		...
		<select name="searchType" id="searchType">
			<option value="" disabled="disabled">여행테마 선택</option>
			<option value="1" <%="1".equals(searchType)?"selected":"" %>>맛집</option>
			<option value="2" <%="2".equals(searchType)?"selected":"" %>>쇼핑</option>
	   		<option value="3" <%="3".equals(searchType)?"selected":"" %>>휴양</option>
	     	<option value="4" <%="4".equals(searchType)?"selected":"" %>>레져</option>
	     	<option value="5" <%="5".equals(searchType)?"selected":"" %>>역사</option>
		</select>
