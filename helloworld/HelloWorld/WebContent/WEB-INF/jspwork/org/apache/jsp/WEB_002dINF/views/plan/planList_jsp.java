 ...
 * Generated at: 2019-06-12 00:28:33 UTC
...
if(memberLoggedIn != null) {
      ...
      out.write("<script>\r\n");
      out.write("$(function(){\r\n");
      out.write("\t$(\".planList-title\").click(function(){\r\n");
      out.write("\t\t$(this).next().toggle(10,function(){\r\n");
      out.write("\t\t\t$(this).prev().toggleClass(\"on\",function(){\r\n");
      out.write("\t\t\t\t$(this).children(\"button\").toggle(10)\t\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("function loadMap(e){\r\n");
      out.write("\tvar pNo=$(e).val();\r\n");
      out.write("\tconsole.log(pNo);\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl:\"");
      out.print(request.getContextPath());
      out.write("/plan/myPlanMapView\",\r\n");
      out.write("\t\tdataType:\"html\",\r\n");
      out.write("\t\tdata: \"planNo=\"+pNo,\r\n");
      out.write("\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t$(\"#\"+pNo).find(\"#planMap\").append(data);\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function deleteFunction(planNo){\r\n");
      out.write("\tvar bool = confirm(\"일정을 삭제하시겠습니까?\");\r\n");
      out.write("\tif(bool){\r\n");
      out.write("\t\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/plan/planDelete?planNo=\"+planNo;\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("<style>\r\n");
      out.write(".on{\r\n");
      out.write("\tborder-left: 6px solid #2dac89;\r\n");
      out.write("\tcolor: #2dac89;\r\n");
      out.write("}\r\n");
      out.write("</style>\r\n");
      out.write("\r\n");
      out.write("<title>MyPlan</title>\r\n");
      out.write("\r\n");
      out.write("<div id=\"myReviewPlan-profile-div\">\r\n");
      out.write("\t<table id=\"myReviewPlan-profile-table\">\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td rowspan=\"2\">\r\n");
      out.write("\t\t\t\t<div id=\"user-profile-div\">\r\n");
      ...
      out.write("\t\t\t\t<span id=\"myReviewPlan-profile-id\">");
      out.print(memberLoggedIn.getMemberId());
      out.write("</span>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<span id=\"myPlanTotal-title\">일정</span>\r\n");
      out.write("\t\t\t\t<span id=\"myPlanTotal\"></span>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<span id=\"myReviewTotal-title\"><a href=\"");
      out.print(request.getContextPath());
      out.write("/review/MyreviewList?LoggedId=");
      out.print(memberLoggedIn.getMemberId());
      out.write("\">리뷰</a></span>\r\n");
      out.write("\t\t\t\t<span id=\"myReviewTotal\"></span>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("</div>\r\n");
      out.write("<br /><br />\r\n");
      out.write("<div id=\"planList-container\">\r\n");
      out.write("\t<ul id=\"planList\">\r\n");
      out.write(" \t \t");
if(planList == null){
      out.write("\r\n");
      out.write("\t\t\t<li>일정이 없습니다.</li>\r\n");
      out.write("\t\t");
}else{
      out.write("\r\n");
      out.write("\t\t\t");
for(Plan p : planList){
      out.write("\r\n");
      out.write("\t\t\t\t<li class=\"planList-title\" onclick=\"loadMap(this);\" value=\"");
      out.print(p.getPlanNo());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t<span id=\"planTitle\">");
      out.print(p.getPlanTitle() );
      out.write("</span><br/>\r\n");
      out.write("\t\t\t\t\t<span id=\"planDate\">");
      out.print(p.getStartDate() );
      out.write(' ');
      out.write('~');
      out.write(' ');
      out.print(p.getEndDate() );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=planNo value=");
      out.print(p.getPlanNo() );
      out.write(" />\r\n");
      out.write("\t\t\t\t\t<button id=\"planUpdate-btn\"\r\n");
      out.write("\t\t\t\t\t\t\tonclick=\"location.href='");
      out.print(request.getContextPath());
      out.write("/plan/planRewriteFrm?planNo=");
      out.print(p.getPlanNo());
      out.write("'\">수정</button>\r\n");
      out.write("\t\t\t\t\t<button id=\"plandelete-btn\"\r\n");
      out.write("\t\t\t\t\t\t\tonclick=\"deleteFunction(");
      out.print(p.getPlanNo() );
      out.write(");\">삭제</button>\r\n");
      out.write("\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li id=\"");
      out.print(p.getPlanNo());
      out.write("\" class=\"myPlan-detail\">\r\n");
      out.write("\t\t\t\t\t\t\t<div id=\"planMap\" class=\"myPlan-detail-map\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"myPlan-detail-list\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t \t");
...
if(pl.getPlaceListLevel()==1){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"myPlan-day\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div id=plan-day>");
      out.print(pl.getDay() );
      out.write("DAY</div><br /><br />\r\n");
      out.write("\t\t\t\t\t\t \t\t\t\t\t");
}
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"myPlan-day-ul\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span id=\"plan-number\">");
      out.print(pl.getPlaceListLevel());
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t");
